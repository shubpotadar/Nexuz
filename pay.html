...
<div class="container" style="padding-top: 3.5rem;">
  <div class="card">
    <button onclick="location.href='myc.html'" class="proceed"><svg class="sendicon" width="24" height="24" viewBox="0 0 24 24">
  <path d="M4,11V13H16L10.5,18.5L11.92,19.92L19.84,12L11.92,4.08L10.5,5.5L16,11H4Z"></path>
</svg></button>
   <img src="images/visa.png" class="logo-card">
 ...
 <input class="input toleft ccv" placeholder="321">
  ...
  <div class="receipt">
    ...
    <p>Name:</p>
    <h2 class="seller">user name</h2>
    </div>
    <div class="col">
      <p>Bought courses:</p>
      <h3 class="bought-items">Python development</h3>
      <p class="bought-items description">Python Training course</p>
      <p class="bought-items price">$50</p><br>
      <h3 class="bought-items">AI & ML</h3>
      <p class="bought-items description">solve complex machine learning problems</p>
